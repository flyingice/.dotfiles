" The following code is copied as it is from
" https://github.com/preservim/vim-markdown/blob/master/syntax/markdown.vim
" to conceal links in markdown snippet returned from language servers. e.g.,
" function signature info in the form of hover text.
" Check for more information regarding the LSP issue:
